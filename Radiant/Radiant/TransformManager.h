...
public:
	...
	void SetTransformChangeCallback4(std::function<void(const Entity&, const DirectX::XMVECTOR&, const DirectX::XMMATRIX&)> callback) { _transformChangeCallback4 = callback; } //Light, contains translation vector and rotation matrix
...
private:
	...
	std::function<void(const Entity&, const DirectX::XMVECTOR&, const DirectX::XMMATRIX&)> _transformChangeCallback4;
