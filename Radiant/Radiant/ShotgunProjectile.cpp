...
ShotgunProjectile::ShotgunProjectile(Entity playerEntity, EntityBuilder* builder) : _builder(builder)
{
	_lifeTime = 1.0f;
	_alive = true;
	_damage = 30.0f;
...
ShotgunProjectile::ShotgunProjectile(XMVECTOR originPos, XMVECTOR originDir, EntityBuilder * builder) : _builder(builder)
{
	_lifeTime = 1.0f;
	_alive = true;
	_damage = 30.0f;
