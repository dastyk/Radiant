...
*/
	...
	_powerChosen = false;
	_builder->Event()->BindEvent(_choice1, EventManager::EventType::LeftClick, [this, firstPower]() {
		_player->AddPower(_allPowers[firstPower]);
		System::GetInput()->LockMouseToCenter(true);
		_powerChosen = true;
	});
	_builder->Event()->BindEvent(_choice2, EventManager::EventType::LeftClick, [this, secondPower]() {
