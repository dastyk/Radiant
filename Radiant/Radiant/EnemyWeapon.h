...
{
protected:
	EnemyWeapon(EntityBuilder* builder, XMFLOAT3 color) : _builder(builder), _weaponColor(color), _cooldown(0), _timeSinceLastActivation(0.0f), _fire(false), _weaponEntity(Entity()){}
public:
