...
EnemyBasicProjectile::EnemyBasicProjectile(Entity enemyEntity, EntityBuilder* builder, XMFLOAT3 parentColor, XMFLOAT3 &playerPosition) : Projectile(builder, enemyEntity)
{
	_lifeTime = 2.2;
	_alive = true;
	_damage = 5.0f;
