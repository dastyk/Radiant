...
public:
	...
	bool operator==(const Weapons& rhs) const
	{
	...
	unsigned int Count() { unsigned int count = 0; for (unsigned int i = 0; i < sizeof(unsigned int); i++) { count += _flags << i; } }
